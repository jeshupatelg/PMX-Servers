...
pipeline {
    ...
    parameters {
        ...
        stringParam(name: 'DEPLOY_SERVERS_LIST', defaultValue: '', description: 'Comma-separated list of servers to deploy (e.g., postgres,kafka or all) when called by other jobs')
    }
